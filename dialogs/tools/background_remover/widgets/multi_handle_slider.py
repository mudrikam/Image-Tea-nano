...
class MultiHandleSlider(QWidget):
    """A horizontal slider with three draggable handles (black, mid, white).

    Emits valuesChanged(black, mid, white) continuously while dragging.
    Uses theme colors for gradient and handles.
    """
    ...
    def paintEvent(self, event):
        ...
        # Gradient: black → gray → white (same as Keong-MAS original)
        ...
        # Draw handles (same as Keong-MAS)
