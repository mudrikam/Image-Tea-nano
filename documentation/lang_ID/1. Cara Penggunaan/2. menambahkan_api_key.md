...
5. Untuk menambahkan OpenRouter di Image Tea (OpenRouter kompatibel dengan OpenAI):
	...
	a. Di dialog **Add API Key**, klik ikon roda gigi di samping dropdown `Model` untuk membuka **Model Manager**. Klik `+` untuk menambahkan id model yang diperlukan (mis. `gpt-4o`, `gpt-5-mini`, atau `openai/gpt-4.1-nano`) lalu simpan.
