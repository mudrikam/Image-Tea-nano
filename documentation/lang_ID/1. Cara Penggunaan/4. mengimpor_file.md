...
![Main table](res/images/main_table.png)

![Main table — Details view](res/images/main_table_details.png)

Tabel utama memiliki beberapa tampilan — gunakan tampilan Details untuk melihat field metadata dan tampilan Thumbnail untuk menelusuri gambar dengan cepat:

![Main table — Thumbnails view](res/images/main_table_thumbnails.png)
