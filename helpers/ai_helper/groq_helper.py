...
def generate_metadata_groq(api_key, model, image_path, prompt=None, stop_flag=None, provider_endpoint=None, preextracted_frames=None, metadata_context=None, generate_prompt=False):
    ...
    try:
        ...
        if is_video:
            if preextracted_frames:
                ...
                print(f"[Groq] Using {len(frame_paths)} pre-extracted frames for video")
            else:
