...
def generate_metadata_blackbox(api_key, model, image_path, prompt=None, stop_flag=None, provider_endpoint=None, preextracted_frames=None, metadata_context=None):
