...
class IllustratorJSXGenerator:
    ...
    def generate_resident_jsx(self):
        ...
        jsx.append("            exportSvgToContent(doc, exportFile, svgOptions);")
        jsx.append("        }")
        ...
        jsx.append("}")
        jsx.append("")
        jsx.append("function exportSvgToContent(doc, exportFile, svgOptions) {")
        ...
        jsx.append("        app.executeMenuCommand('deselectall');")
        jsx.append("    }")
        jsx.append("    if (!bounds || bounds[2] <= bounds[0] || bounds[1] <= bounds[3]) {")
        ...
        jsx.append("    var temporaryArtboard = doc.artboards.add(bounds);")
        jsx.append("    var temporaryArtboardIndex = doc.artboards.length - 1;")
        jsx.append("    doc.artboards.setActiveArtboardIndex(temporaryArtboardIndex);")
        jsx.append("    svgOptions.artboardClipping = true;")
        jsx.append("    svgOptions.artboardRange = String(temporaryArtboardIndex + 1);")
        jsx.append("    doc.exportFile(exportFile, ExportType.SVG, svgOptions);")
        jsx.append("}")
        jsx.append("")
